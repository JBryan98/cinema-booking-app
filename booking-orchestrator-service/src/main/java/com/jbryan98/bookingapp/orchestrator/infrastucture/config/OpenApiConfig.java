 ...
 * <p>
 * UI: http://localhost:51400/api/v1/swagger-ui.html
 * Spec JSON: http://localhost:51400/api/v1/v3/api-docs
 */
@Configuration
public class OpenApiConfig {
    ...
    public OpenAPI orderServiceOpenAPI() {
        return new OpenAPI()
                .info(
                        new Info()
                                .title("Booking Orchestrator Service API")
                                .description("Servicio orquestador de reservas del cinema-booking-app MitoCode.")
                                .version("7.8.25")
                                .contact(
                                        new Contact()
                                                .name("Bryan Corrales")
